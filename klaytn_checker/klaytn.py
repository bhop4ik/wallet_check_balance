...
CONFLUX_RPC_URL = 'https://klaytn.blockpi.network/v1/rpc/public'
...
async def main():
    ...
    with open('wallet_klaytn.csv', 'w', newline='') as csvfile:
...
if __name__ == "__main__":
    asyncio.run(main())
    print("Data has been written to wallet_klaytn.csv")