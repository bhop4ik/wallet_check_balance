...
CONFLUX_RPC_URL = 'https://moonbeam.publicnode.com'
...
async def main():
    ...
    with open('wallet_moonbeam.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(['Wallet', 'Native Token Amount (glmr)', 'TX Count'])
...
if __name__ == "__main__":
    asyncio.run(main())
    print("Data has been written to wallet_moonbeam.csv")